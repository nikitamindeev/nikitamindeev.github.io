...
export interface WebApp {
     ...
     * @param eventHandler
     */
    onEvent(eventType: unknown, eventHandler: () => void): unknown
    /**
     ...
     * @param eventHandler
     */
    offEvent(eventType: unknown, eventHandler: () => void): unknown
    /**
     ...
     * @param url
     */
    openInvoice(unknown: unknown): unknown
    /**
     ...
     * @param params
     */
    showPopup(params: unknown, callback?: (id: string) => void): unknown
    /**
     ...
     * @param message
     */
    showAlert(message: unknown): unknown
    /**
     ...
     * @param message
     */
    showConfirm(message: unknown): unknown
    /**
     ...
     * @param params
     */
    showScanQrPopup(params: unknown): unknown
    /**
     ...
     * @param callback
     */
    readTextFromClipboard(callback: unknown): unknown
    /**
